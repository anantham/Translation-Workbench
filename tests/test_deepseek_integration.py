...
if api_key:
    ...
    print(f"   1. Set DEEPSEEK_API_KEY environment variable")
    print(f"   2. Select 'OpenAI' platform in Translation Lab")
    print(f"   3. Choose 'deepseek-chat' or 'deepseek-reasoner' model")
    print(f"   4. Models will automatically use DeepSeek API with base_url")
else:
